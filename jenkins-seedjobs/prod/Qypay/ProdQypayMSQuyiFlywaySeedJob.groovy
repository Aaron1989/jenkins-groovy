...
def COMPILE_JOB_NAME = Folder+'/'+'Prod-Qypay-MS-QuyiFlyway-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = Folder+'/'+'Prod-Qypay-MS-QuyiFlyway-Deploy' //发布job名称，不可以使用中文
...
pipelineJob("$PIPELINE_JOB_NAME1") {
  ...
  definition {
    cpsScm {
      ...
      scriptPath("jenkins-pipelines/prodd/Qypay/Prod-Qypay-MS-QuyiFlyway-Pipeline.groovy")
    }
  }
}