...
def DEPLOY_JOB_NAME = Folder+'/'+'Prod-Hms-MS-Telemed-Deploy' //发布job名称，不可以使用中文
...
def EXPORT =''
def APP_NAME = 'ms-telemed-transfer'  //微服务名称,一般固定在代码里，若不修改则为空
...
pipelineJob("$PIPELINE_JOB_NAME") {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("jenkins-pipelines/prodd/NewHms/Prod-Hms-MS-Telemed-Pipeline.groovy")
        }
    }
}
