...
def COMPILE_JOB_NAME = Folder+'/'+'Prod-MiddleLayer-MsPublic-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = Folder+'/'+'Prod-MiddleLayer-MMsPublic-Deploy-Gray' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = Folder+'/'+'Prod-MiddleLayer-MsPublic-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME3 = Folder+'/'+'Prod-MiddleLayer-MsPublic-Deploy2' //发布job名称，不可以使用中文
//def DEPLOY_JOB_NAME3 = Folder+'/'+'Prod-MiddleLayer-MsPublic-Deploy3' //发布job名称，不可以使用中文
//def DEPLOY_JOB_NAME4 = Folder+'/'+'Prod-MiddleLayer-MMsPublic-Deploy-Gray' //发布job名称，不可以使用中文
def PIPELINE_JOB_NAME1 = Folder+'/'+'Prod-MiddleLayer-MsPublic-Pipeline'
def ECS_IP = [' ', ' ', ' ']
...
def PRODUCTION = 'ms-cloud'   //产品名称，该参数表示oss存储路径和部署服务器路径中微服务名
def WAR_NAME = 'ms-public-1.0-SNAPSHOT.war'  //jar包名称


//
def APP_NAME = 'ms-public'  //微服务名称,一般固定在代码里，若不修改则为空
...
def ScriptPath = 'prod/'+GROUP+'/Prod-MiddleLayer-MsPublic-Pipeline'
