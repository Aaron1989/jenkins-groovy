//发布job初始化
def Folder = 'Prod-Plugins/test'

def COMPILE_JOB_NAME = Folder+'/'+'Prod-Hms-BackEnd-HMS-Compile2' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = Folder+'/'+'Prod-Hms-BackEnd-HMS-Deploy2' //发布job名称，不可以使用中文
def PIPELINE_JOB_NAME =  Folder+'/'+'Prod-Hms-BackEnd-HMS-Pipeline2'
def ECS_IP = [' ']
