...
def COMPILE_JOB_NAME = Folder+'/'+'Gray-Plugins-MsInformation-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = Folder+'/'+'Gray-Plugins-MsInformation-Deploy' //发布job名称，不可以使用中文
...
def APP_NAME = 'ms-information-pre'  //微服务名称,一般固定在代码里，若不修改则为空
