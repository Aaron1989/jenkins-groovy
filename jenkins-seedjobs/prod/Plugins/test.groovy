...
def COMPILE_JOB_NAME = Folder+'/'+'Prod-Hms-BackEnd-HMS-Compile1' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = Folder+'/'+'Prod-Hms-BackEnd-HMS-Deploy1' //发布job名称，不可以使用中文
def PIPELINE_JOB_NAME =  Folder+'/'+'Prod-Hms-BackEnd-HMS-Pipeline1'
def ECS_IP = [' ']
