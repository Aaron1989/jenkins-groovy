...
def COMPILE_JOB_NAME = Folder+'/'+'Gray-Plugins-MsInformationBackend-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = Folder+'/'+'Gray-Plugins-MsInformationBackend-Deploy' //发布job名称，不可以使用中文
