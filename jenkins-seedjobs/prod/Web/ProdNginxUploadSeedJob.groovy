...
def gitUrl = "http://h.quyiyuan.com/scm/qyw/qy-web-xml.git"
...
def Folder = "Prod-Web"
def JobName = Folder+ '/' +'Prod-Web-Nginx-Upload-Compile'
...
//    mavenInstallation('maven-3.2.5')
    ...
    steps{
        shell(
                "python /opt/OSS_Python_API/osscmd uploadfromdir website/nginx/ oss://qy-images/nginx --check_point=check_point_file --check_md5=true"
        )
    }
