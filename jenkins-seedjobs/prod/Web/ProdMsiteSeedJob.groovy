...
pipelineJob(pipelineJobName) {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("jenkins-pipelines/prodd/Web/Prod-Msite-Pipeline")
        }
    }
}
