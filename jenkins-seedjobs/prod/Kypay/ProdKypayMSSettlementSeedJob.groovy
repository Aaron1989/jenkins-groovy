...
def COMPILE_JOB_NAME = Folder+'/'+'Prod-Kypay-MS-Settlement-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = Folder+'/'+'Prod-Kypay-MS-Settlement-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = Folder+'/'+'Prod-Kypay-MS-Settlement-Deploy2' //发布job名称，不可以使用中文
def PIPELINE_JOB_NAME1 = Folder+'/'+'Prod-Kypay-MS-Settlement-Pipeline'
...
pipelineJob("$PIPELINE_JOB_NAME1") {
  ...
  definition {
    cpsScm {
      ...
      scriptPath("jenkins-pipelines/prodd/Kypay/Prod-Kypay-MS-Settlement-Pipeline.groovy")
    }
  }
}