...
def COMPILE_JOB_NAME = Folder+'/'+'Prod-Kypay-EurekaServer-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = Folder+'/'+'Prod-Kypay-EurekaServer-Deploy1' //发布job名称，不可以使用中文
...
pipelineJob("$PIPELINE_JOB_NAME1") {
  ...
  definition {
    cpsScm {
      ...
      scriptPath("jenkins-pipelines/prodd/Kypay/Prod-Kypay-EurekaServer-Pipeline.groovy")
    }
  }
}