...
def COMPILE_JOB_NAME = Folder+'/'+'Prod-Kypay-MS-File-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = Folder+'/'+'Prod-Kypay-MS-File-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = Folder+'/'+'Prod-Kypay-MS-File-Deploy2' //发布job名称，不可以使用中文
def PIPELINE_JOB_NAME1 = Folder+'/'+'Prod-Kypay-MS-File-Pipeline'


def GITURL = 'http://h.quyiyuan.com/scm/qypay/ms-file.git' //git仓库地址
...
def WAR_NAME = 'ms-file.war'  //WAR包名称
...
pipelineJob("$PIPELINE_JOB_NAME1") {
  ...
  definition {
    cpsScm {
      ...
      scriptPath("jenkins-pipelines/prodd/Kypay/Prod-Kypay-MS-File-Pipeline.groovy")
    }
  }
}