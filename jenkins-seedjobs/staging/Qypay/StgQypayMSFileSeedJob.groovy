...
def COMPILE_JOB_NAME = Folder+'/'+'Stg-Qypay-MS-File-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = Folder+'/'+'Stg-Qypay-MS-File-Deploy' //发布job名称，不可以使用中文
def PIPELINE_JOB_NAME1 = Folder+'/'+ 'Stg-Qypay-MS-File-Pipeline'
...
pipelineJob("$PIPELINE_JOB_NAME1") {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("jenkins-pipelines/staging/Qypay/Stg-Qypay-MS-File-Pipeline.groovy")
        }
    }
}