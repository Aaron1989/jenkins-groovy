...
def COMPILE_JOB_NAME = Folder+'/'+'Stg-Qypay-MS-Settlement-Compile' //编译job名称，不可以使用中文
...
pipelineJob("$PIPELINE_JOB_NAME1") {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("jenkins-pipelines/staging/Qypay/Stg-Qypay-MS-Settlement-Pipeline.groovy")
        }
    }
}