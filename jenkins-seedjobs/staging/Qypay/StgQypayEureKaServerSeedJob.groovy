...
def COMPILE_JOB_NAME = Folder+'/'+'Stg-Qypay-EureKaServer-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = Folder+'/'+'Stg-Qypay-EureKaServer-Deploy' //发布job名称，不可以使用中文
...
pipelineJob("$PIPELINE_JOB_NAME1"){
    ...
    definition {
        cpsScm {
            ...
            scriptPath("jenkins-pipelines/staging/Qypay/Stg-Qypay-EureKaServer-Pipeline.groovy")
        }
    }
}