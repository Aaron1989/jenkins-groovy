...
def COMPILE_JOB_NAME = Folder+'/'+'Stg-Website-Compile-1'
def COMPILE_JOB_NAME2 = Folder+'/'+'Stg-Website-Import-Compile-1'
def DEPLOY_JOB_NAME1 = Folder+'/'+'Stg-Website-Compose-Build-1'
def DEPLOY_JOB_NAME2 = Folder+'/'+'Stg-Website-Image-Push-1'
def DEPLOY_JOB_NAME3 = Folder+'/'+'Stg-Website-Compose-Up-1'
def PIPELINE_JOB_NAME1 = Folder+'/'+'Stg-Website-Pipeline-1'
...
def GITURL1 = 'http://h.quyiyuan.com/scm/qyw/qy-web-ant.git'
def GITURL2 = 'http://h.quyiyuan.com/scm/dcd/dockercd-website'
def GITURL3 = 'http://h.quyiyuan.com/scm/qyw/qy-web-import.git'
def PROFILE_ACTIVE = 'diststaging'
def GULP_ENV = 'stg'

def DockerMasterUrl ='https://master3g3.cs-cn-qingdao.aliyun.com:20063'
def DockerAppName = 'stg-1'
...
pipelineJob("$PIPELINE_JOB_NAME1") {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("jenkins-pipelines/staging/Website/Stg-Website-Pipeline-1.groovy")
        }
    }
}
