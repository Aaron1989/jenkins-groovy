...
def COMPILE_JOB_NAME = Folder+'/'+'Stg-Website-Compile-2'
def COMPILE_JOB_NAME2 = Folder+'/'+'Stg-Website-Import-Compile-2'
def DEPLOY_JOB_NAME1 = Folder+'/'+'Stg-Website-Compose-Build-2'
def DEPLOY_JOB_NAME2 = Folder+'/'+'Stg-Website-Image-Push-2'
def DEPLOY_JOB_NAME3 = Folder+'/'+'Stg-Website-Compose-Up-2'
def PIPELINE_JOB_NAME1 = Folder+'/'+'Stg-Website-Pipeline-2'
...
pipelineJob("$PIPELINE_JOB_NAME1") {
    ...
    parameters {
            ...
            string {
                    defaultValue('')
                    description('测试地址为m.quyiyuan.com')
                    name('platform')
            }
            string {
                defaultValue('false')
    ...
    definition {
        cpsScm {
            ...
            scriptPath("jenkins-pipelines/staging/Website/Stg-Website-Pipeline-2.groovy")
        }
    }
}
