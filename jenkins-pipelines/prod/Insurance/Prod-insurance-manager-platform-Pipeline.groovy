def COMPILE_JOB_NAME = 'Prod-Insurance-Manager-Platform-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = 'Prod-Insurance-Manager-Platform-Deploy' //发布job名称，不可以使用中文
def GROUP = 'qybx'
...
def WAR_NAME = 'insurance_manger_platform-1.0-SNAPSHOT.jar'
properties ([
    parameters ([
