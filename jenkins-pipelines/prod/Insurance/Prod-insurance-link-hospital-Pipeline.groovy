def COMPILE_JOB_NAME = 'Prod-Insurance-Link-Hospital-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = 'Prod-Insurance-Link-Hospital-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = 'Prod-Insurance-Link-Hospital-Deploy2' //发布job名称，不可以使用中文

def TAG = ''
def OLD_VERSION = ''
def BRANCH = ''
def WAR_NAME = 'hospital_link-0.0.1-SNAPSHOT.jar'
properties ([
    parameters ([
