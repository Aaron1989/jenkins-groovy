def COMPILE_JOB_NAME = 'Prod-Insurance-Hospital-Accessor-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = 'Prod-Insurance-Hospital-Accessor-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = 'Prod-Insurance-Hospital-Accessor-Deploy2' //发布job名称，不可以使用中文
def GROUP = 'qybx'
...
def OLD_VERSION = ''
def BRANCH = ''
def WAR_NAME = 'hospital-accessor-1.0-SNAPSHOT.jar'
properties ([
    parameters ([
