def COMPILE_JOB_NAME = 'Prod-Insurance-Lp-Zp-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = 'Prod-Insurance-Lp-Zp-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = 'Prod-Insurance-Lp-Zp-Deploy2' //发布job名称，不可以使用中文
def GROUP = 'qybx'
...
def OLD_VERSION = ''
def BRANCH = ''*/
def WAR_NAME = 'insurance_lp_zp-0.0.1.jar'
properties ([
    parameters ([
