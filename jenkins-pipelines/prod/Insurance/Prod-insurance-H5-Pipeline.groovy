def COMPILE_JOB_NAME = 'Prod-Insurance-H5-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = 'Prod-Insurance-H5-Deploy' //发布job名称，不可以使用中文
...
def REPOSITORY_URL = 'http://h.quyiyuan.com/scm/in/insurance-h5.git'

def WAR_NAME = 'www.tar.gz'
