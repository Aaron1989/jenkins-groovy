def COMPILE_JOB_NAME = 'Prod-Insurance-Zuul-Router-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = 'Prod-Insurance-Zuul-Router-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = 'Prod-Insurance-Zuul-Router-Deploy2' //发布job名称，不可以使用中文
...
def WAR_NAME = 'zuul-router-1.0-SNAPSHOT.jar'
properties ([
    parameters ([
