def COMPILE_JOB_NAME = 'Prod-Insurance-Ms-Oauth-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = 'Prod-Insurance-Ms-Oauth-Deploy' //发布job名称，不可以使用中文
...
def WAR_NAME = 'oauth2-server-1.0-SNAPSHOT.jar'
properties ([
    parameters ([
