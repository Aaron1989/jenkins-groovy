def COMPILE_JOB_NAME = 'Prod-Insurance-Zipkin-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = 'Prod-Insurance-Zipkin-Deploy' //发布job名称，不可以使用中文
...
def BRANCH = ''
def WAR_NAME = 'zipkin-server-1.0-SNAPSHOT.jar'
properties ([
    parameters ([
