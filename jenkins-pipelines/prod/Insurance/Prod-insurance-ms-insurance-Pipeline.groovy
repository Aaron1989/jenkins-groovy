def COMPILE_JOB_NAME = 'Prod-Insurance-Ms-Insurance-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = 'Prod-Insurance-Ms-Insurance-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = 'Prod-Insurance-Ms-Insurance-Deploy2' //发布job名称，不可以使用中文
...
node {
    ...
    stage('Compile') {
        build job: "$COMPILE_JOB_NAME", parameters: [string(name: 'TAG', value: TAG), string(name: 'BRANCH', value: BRANCH), text(name: 'Description', value: Description)]
    }
