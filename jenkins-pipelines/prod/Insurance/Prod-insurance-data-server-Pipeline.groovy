def COMPILE_JOB_NAME = 'Prod-Insurance-Data-Server-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME = 'Prod-Insurance-Data-Server-Deploy' //发布job名称，不可以使用中文
def IP_LIST = [' ',' ']
...
def WAR_NAME = 'insurance-data-server-1.0-SNAPSHOT.jar'
