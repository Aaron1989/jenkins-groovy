def COMPILE_JOB_NAME = 'Prod-Insurance-Lp-Manage-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = 'Prod-Insurance-Lp-Manage-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = 'Prod-Insurance-Lp-Manage-Deploy2' //发布job名称，不可以使用中文
def GROUP = 'qybx'
...
def WAR_NAME = 'insurance_lp_manage-0.0.1.jar'
properties ([
    parameters ([
