def COMPILE_JOB_NAME = 'Prod-Insurance-Eureka-Compile' //编译job名称，不可以使用中文
def DEPLOY_JOB_NAME1 = 'Prod-Insurance-Eureka-Deploy1' //发布job名称，不可以使用中文
def DEPLOY_JOB_NAME2 = 'Prod-Insurance-Eureka-Deploy2' //发布job名称，不可以使用中文

def TAG = ''
def OLD_VERSION = ''
def BRANCH = ''
def WAR_NAME = 'eureka-server-1.0-SNAPSHOT.jar'
properties ([
    parameters ([
