...
def COMPILE_JOB_NAME = 'Prod-Kypay-MS-Settlement-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Kypay-MS-Settlement-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Kypay-MS-Settlement-Deploy2'
def BRANCH = '*/release'
def WAR_NAME = 'ms-settlement.war'
def SHELL_NAME = 'Prod_Ky_Microservice'
...
node {
    ...
    stage('deploy2'){
        input 'Whether to release Prod-Kypay-MS-Settlement-Deploy2?'
