...
def COMPILE_JOB_NAME = 'Prod-Kypay-MS-Mq-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Kypay-MS-Mq-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Kypay-MS-Mq-Deploy2'
def BRANCH = '*/release'
def WAR_NAME = 'ms-mq.war'
...
node {
    ...
    stage('deploy2'){
        input 'Whether to release Prod-Kypay-MS-Mq-Deploy2?'
