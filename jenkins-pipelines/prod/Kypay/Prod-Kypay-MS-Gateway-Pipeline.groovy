...
def COMPILE_JOB_NAME = 'Prod-Kypay-MS-Gateway-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Kypay-MS-Gateway-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Kypay-MS-Gateway-Deploy2'
def BRANCH = '*/release'
def WAR_NAME = 'ms-gateway.war'
...
node {
    ...
    stage('deploy2'){
        input 'Whether to release Prod-Kypay-MS-Gateway-Deploy2?'
