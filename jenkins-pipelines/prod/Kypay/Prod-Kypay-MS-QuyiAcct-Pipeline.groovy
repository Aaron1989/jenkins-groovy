...
def COMPILE_JOB_NAME = 'Prod-Kypay-MS-QuyiAcct-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Kypay-MS-QuyiAcct-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Kypay-MS-QuyiAcct-Deploy2'
def BRANCH = '*/release'
def WAR_NAME = 'ms-quyiacct.war'
...
node {
    ...
    stage('deploy2'){
        input 'Whether to release Prod-Kypay-MS-QuyiAcct-Deploy2?'
