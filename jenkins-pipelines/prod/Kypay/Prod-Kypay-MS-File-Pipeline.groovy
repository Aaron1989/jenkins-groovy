...
def COMPILE_JOB_NAME = 'Prod-Kypay-MS-File-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Kypay-MS-File-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Kypay-MS-File-Deploy2'
def BRANCH = '*/release'
def WAR_NAME = 'ms-file.war'
...
node {
    ...
    stage('deploy2'){
        input 'Whether to release Prod-Kypay-MS-File-Deploy2?'
