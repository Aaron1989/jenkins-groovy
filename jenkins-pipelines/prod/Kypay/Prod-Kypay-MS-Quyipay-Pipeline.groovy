...
def COMPILE_JOB_NAME = 'Prod-Kypay-MS-Quyipay-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Kypay-MS-Quyipay-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Kypay-MS-Quyipay-Deploy2'
def BRANCH = '*/release'
...
node {
    ...
    stage('deploy2'){
        input 'Whether to release Prod-Kypay-MS-Quyipay-Deploy2?'
