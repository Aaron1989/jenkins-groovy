...
def COMPILE_JOB_NAME = 'Prod-MiddleLayer-MsCloud-Compile'
def DEPLOY_JOB_NAMES = ['Prod-MiddleLayer-MsCloud-Deploy1','Prod-MiddleLayer-MsCloud-Deploy2']
def BRANCH = '*/release'
def WAR_NAME = 'Web-1.0-SNAPSHOT.war'
