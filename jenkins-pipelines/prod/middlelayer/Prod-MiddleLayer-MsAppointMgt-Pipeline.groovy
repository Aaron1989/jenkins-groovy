...
def COMPILE_JOB_NAME = 'Prod-MiddleLayer-MsAppointMgt-Compile'
def DEPLOY_JOB_NAMES = ['Prod-MiddleLayer-MsAppointMgt-deploy']
def BRANCH = '*/release'
def WAR_NAME = 'appoint-mgt-1.0-SNAPSHOT.war'
