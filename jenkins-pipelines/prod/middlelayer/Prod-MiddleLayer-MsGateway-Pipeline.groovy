...
def COMPILE_JOB_NAME = 'Prod-MiddleLayer-MsGateway-Compile'
def DEPLOY_JOB_NAMES = ['Prod-MiddleLayer-MsGateway-Deploy1','Prod-MiddleLayer-MsGateway-Deploy2','Prod-MiddleLayer-MsGateway-Deploy3','Prod-MiddleLayer-MsGateway-Deploy4','Prod-MiddleLayer-MsGateway-Deploy5','Prod-MiddleLayer-MsGateway-Deploy6',]
def BRANCH = '*/release'
def WAR_NAME = 'qy-gateway-1.0-SNAPSHOT.war'
