...
def COMPILE_JOB_NAME = 'Prod-MiddleLayer-MsAuth-Compile'
def DEPLOY_JOB_NAMES = ['Prod-MiddleLayer-MsAuth-Deploy1','Prod-MiddleLayer-MsAuth-Deploy2']
def BRANCH = '*/release'
def WAR_NAME = 'oauth2-0.0.1-SNAPSHOT.jar'
