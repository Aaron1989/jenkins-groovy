...
if __name__ == '__main__':
    ...
    loadbalancerid = ['lb-m5ehcf14pzwb2x0aink3l']
    ...
    for m in loadbalancerid:
        ...
        # if count == 0:
            #灰度机器
        slb.SetBackendServers('i-28gvxulfo',gray_weight)
        slb.SetBackendServers('i-28r9tvwho',gray_weight)
        ...
        #生产机器
        slb.SetBackendServers('i-m5e9ulw448ikjxfvyw8n',prod_weight)
        slb.SetBackendServers('i-m5e9ulw448ikjxfvyw8m',prod_weight)
        ...
        for i in slb.CheckStatus()['BackendServers']['BackendServer']:
            ...
            if (i['ServerId']) == 'i-28cl7r4pk' or (i['ServerId']) == 'i-28cq99swx' \
                ...
                print '灰度',
            elif (i['ServerId']) == 'i-28qmfjjtk' or (i['ServerId']) == 'i-285gyz03w'\
                    or (i['ServerId']) == 'i-28z2rfbl0' or (i['ServerId']) == 'i-28i8kdzem':
                print '灰度docker',
            print i['Weight'],
        print '\n'
