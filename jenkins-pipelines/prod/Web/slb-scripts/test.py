...
if __name__ == '__main__':
    ...
    loadbalancerid = ['lb-uf68ni0mrg67csgzbsnu7']
    access_key = 'LTAIw9bdfqVlvBmM'
    secret_key = '4tbdlm1Tjkoo4e47JeCYfBa0DQmuCj'
    ...
    for m in loadbalancerid:
        ...
        # if count == 0:
            #灰度机器
        slb.SetBackendServers('i-uf6dk116xwtvxxpg83gr',gray_weight)
        slb.SetBackendServers('i-uf6dk116xwtvxxpg83go',gray_weight)
        # slb.SetBackendServers('i-28kxlnd3x',gray_weight)
        # slb.SetBackendServers('i-28bjlb3q0',gray_weight)
        # slb.SetBackendServers('i-28cbujys8',gray_weight)
        # slb.SetBackendServers('i-28c0nw3al',gray_weight)

        #docker机器
        slb.SetBackendServers('i-uf6dk116xwtvxxpg83gn',docker_weight)
        slb.SetBackendServers('i-uf6dk116xwtvxxpg83gq',docker_weight)
        slb.SetBackendServers('i-uf6dk116xwtvxxpg83gp',docker_weight)
        ...
        #生产机器
        slb.SetBackendServers('i-uf6cm4ndtkaulv97ygxd',prod_weight)
        slb.SetBackendServers('i-uf6cm4ndtkaulv97ygxe',prod_weight)
        # slb.SetBackendServers('i-28cq99swx',prod_weight)
        # slb.SetBackendServers('i-28cl7r4pk',prod_weight)
        # slb.SetBackendServers('i-28nfaeiij',prod_weight)
        # slb.SetBackendServers('i-28wcjlql1',prod_weight)
        ...
        for i in slb.CheckStatus()['BackendServers']['BackendServer']:
            # print i
            if (i['ServerId']) == 'i-uf6dk116xwtvxxpg83gr' or (i['ServerId']) == 'i-uf6dk116xwtvxxpg83go':
                print '老版本',
            elif (i['ServerId']) == 'i-uf6dk116xwtvxxpg83gn' or (i['ServerId']) == 'i-uf6dk116xwtvxxpg83gq' \
                    or (i['ServerId']) == 'i-uf6dk116xwtvxxpg83gp':
                print '灰度',
            elif (i['ServerId']) == 'i-uf6cm4ndtkaulv97ygxd' or (i['ServerId']) == 'i-uf6cm4ndtkaulv97ygxe':
                print '灰度docker',
            print i['Weight'],
        print '\n'
