def COMPILE_JOB_NAME = 'Prod-Plugins-MsDiseaseBackend-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Plugins-MsDiseaseBackend-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Plugins-MsDiseaseBackend-Deploy2'

def TAG = ''
def OLD_VERSION = ''
def BRANCH = '*/release'
def WAR_NAME = 'Backend-Medicine-0.0.1.war'
properties ([
    parameters ([
