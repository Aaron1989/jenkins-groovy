def COMPILE_JOB_NAME = 'Prod-Plugins-MsDisease-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Plugins-MsDisease-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Plugins-MsDisease-Deploy2'

def TAG = ' '
def OLD_VERSION = ' '
def BRANCH = '*/release'
def WAR_NAME = 'MS-Disease-0.0.1.war'
properties ([
    parameters ([
