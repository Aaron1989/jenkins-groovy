def COMPILE_JOB_NAME1 = 'Gray-Plugins-MsDoctor-Compile'
def COMPILE_JOB_NAME2 = 'Prod-Plugins-MsDoctor-Compile'
def DEPLOY_JOB_NAME1 = 'Gray-Plugins-MsDoctor-Deploy'
def DEPLOY_JOB_NAME2 = 'Prod-Plugins-MsDoctor-Deploy1'
def DEPLOY_JOB_NAME3 = 'Prod-Plugins-MsDoctor-Deploy2'
def DEPLOY_JOB_NAME4 = 'Prod-Plugins-MsDoctor-Deploy3'
def TAG = ''
def OLD_VERSION = ''
def BRANCH = '*/release'
def WAR_NAME = 'MS-Doctor-0.0.1.war'
properties ([
    parameters ([
