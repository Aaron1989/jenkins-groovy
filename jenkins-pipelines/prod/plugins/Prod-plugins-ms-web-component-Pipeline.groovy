def COMPILE_JOB_NAME1 = 'Gray-Plugins-MsWebcomponent-Compile'
def COMPILE_JOB_NAME2 = 'Prod-Plugins-MsWebcomponent-Compile'
def DEPLOY_JOB_NAME1 = 'Gray-Plugins-MsWebcomponent-Deploy'
def DEPLOY_JOB_NAME2 = 'Prod-Plugins-MsWebcomponent-Deploy1'
def DEPLOY_JOB_NAME3 = 'Prod-Plugins-MsWebcomponent-Deploy2'

def TAG = ''
def OLD_VERSION = ''
def BRANCH = '*/release'
def WAR_NAME = 'Web-Component-0.0.1.war'
def Description = ''
properties ([
    parameters ([
