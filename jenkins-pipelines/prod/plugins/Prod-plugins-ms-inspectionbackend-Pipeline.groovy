def COMPILE_JOB_NAME = 'Prod-Plugins-MsInspectionBackend-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Plugins-MsInspectionBackend-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Plugins-MsInspectionBackend-Deploy2'

def TAG = ''
def OLD_VERSION = ''
def BRANCH = '*/release'
def WAR_NAME = 'Backend-Inspection-0.0.1.war'
properties ([
    parameters ([
