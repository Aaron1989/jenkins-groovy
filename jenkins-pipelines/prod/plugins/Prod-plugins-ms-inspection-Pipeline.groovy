def COMPILE_JOB_NAME = 'Prod-Plugins-MsInspection-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Plugins-MsInspection-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Plugins-MsInspection-Deploy2'

def TAG = ''
def OLD_VERSION = ''
def BRANCH = '*/release'
def WAR_NAME = 'MS-Inspection-0.0.1.war'
properties ([
    parameters ([
