def COMPILE_JOB_NAME = 'Prod-Hms-MS-Drugstore-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Hms-MS-Drugstore-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Hms-MS-Drugstore-Deploy2'
