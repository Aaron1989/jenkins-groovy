def COMPILE_JOB_NAME = 'Prod-Hms-MS-Backend-Rtc-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Hms-MS-Backend-Rtc-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Hms-MS-Backend-Rtc-Deploy2'
