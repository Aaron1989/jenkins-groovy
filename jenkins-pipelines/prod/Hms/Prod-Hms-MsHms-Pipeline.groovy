def COMPILE_JOB_NAME = 'Prod-Hms-MS-HMS-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Hms-MS-HMS-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Hms-MS-HMS-Deploy2'
...
node {
    stage('Compile') {
        build job: "$COMPILE_JOB_NAME", parameters: [string(name: 'TAG', value:env.TAG), string(name: 'BRANCH', value: env.BRANCH), string(name: 'WAR_NAME', value: WAR_NAME), text(name: 'Description', value: env.Description)]
    }
    stage('Deploy1') {
