...
def applicationName = 'hms-ms-aid'
def compileJobName = 'Prod-Hms-Ms-Aid-Compile1'
    ...
    stage('Prod Deploy'){
      for (def ip: prodIps) {
        ...
        build job: 'Prod-Public/Prod-Public-Check-Port-Job', parameters: [string(name: 'IP', value: ip),
          ...
          //   input 'Whether to go on?'
          //   build job: 'Prod-Public/Prod-Public-Deploy', parameters: [string(name: 'APP_NAME', value: prodInfo['service']),
          //         string(name: 'IP', value: prodIps[0]), password(description: '', name: 'JPS_PWD',
          //           value: jpsPassword.toString())]
	        // input 'Whether to go on?'
          //   build job: 'Prod-Public/Prod-Public-Deploy', parameters: [string(name: 'APP_NAME', value: prodInfo['service']),
          //         string(name: 'IP', value: prodIps[1]), password(description: '', name: 'JPS_PWD',
          //           value: jpsPassword.toString())]
