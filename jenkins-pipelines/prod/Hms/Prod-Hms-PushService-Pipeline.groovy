def COMPILE_JOB_NAME = 'Prod-Hms-MS-PushService-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Hms-MS-PushService-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Hms-MS-PushService-Deploy2'
