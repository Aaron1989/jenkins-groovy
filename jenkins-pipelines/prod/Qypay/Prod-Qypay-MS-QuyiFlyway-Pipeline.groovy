...
def COMPILE_JOB_NAME = 'Prod-Qypay-MS-QuyiFlyway-Compile'
def DEPLOY_JOB_NAME = 'Prod-Qypay-MS-QuyiFlyway-Deploy'
def BRANCH = '*/release'
def WAR_NAME = 'ms-quyiflyway.war'
...
node {
    ...
    stage('deploy'){
        input 'Whether to release Prod-Qypay-MS-QuyiFlyway-Deploy?'
