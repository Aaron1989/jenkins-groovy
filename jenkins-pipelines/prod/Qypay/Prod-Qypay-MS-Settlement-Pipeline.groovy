...
def COMPILE_JOB_NAME = 'Prod-Qypay-MS-Settlement-Compile'
def DEPLOY_JOB_NAME1 = 'Prod-Qypay-MS-Settlement-Deploy1'
def DEPLOY_JOB_NAME2 = 'Prod-Qypay-MS-Settlement-Deploy2'
def BRANCH = '*/release'
...
node {
    ...
    stage('deploy2'){
        input 'Whether to release Prod-Qypay-MS-Settlement-Deploy2?'
