...
def COMPILE_JOB_NAME = 'Prod-Qypay-MS-ReconBatch-Compile'
def DEPLOY_JOB_NAME = 'Prod-Qypay-MS-ReconBatch-Deploy'
def BRANCH = '*/release'
def WAR_NAME = 'ms-reconbatch.war'
...
node {
    ...
    stage('deploy'){
        input 'Whether to release Prod-Qypay-MS-ReconBatch-Deploy?'
