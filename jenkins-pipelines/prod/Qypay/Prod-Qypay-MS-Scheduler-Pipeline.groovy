...
def COMPILE_JOB_NAME = 'Prod-Qypay-MS-Scheduler-Compile'
def DEPLOY_JOB_NAME = 'Prod-Qypay-MS-Scheduler-Deploy'
def BRANCH = '*/release'
...
node {
    ...
    stage('deploy') {
        input 'Whether to release Prod-Qypay-MS-Scheduler-Deploy?'
